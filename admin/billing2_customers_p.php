...
<div class="cloth">
		...
		<div class="shirt_right">
			...
			while($rs_one = mysql_fetch_array($get_one))
			{
				...
				echo $customers_com    = $rs_one['customers_com'];
					  ...
					  <input name="button" type="button" value="กลับ" onclick="window.location='billing2_customers.php';"/>
                      <? if($_GET[fix]=="true"){?>
		...
		<tr>
			<td width="64%">
				...
				<? }else { ?>
   					<a href="" style="text-decoration:none; color:#000000;">ชื่อโปรเจค</a><a href="" style="text-decoration:none; color:#000000;"></a>
				<? } ?>			</td>
			<td width="24%"><a href="?stack=orderid_date1&amp;type_stack=ASC" style="text-decoration:none; color:#000000;">หมวดหมู่โปรเจค</a> </td>
	...
	?>
  	<tr id="tr<?=$i?>" onMouseOver='mOvr(this,"#E6E6E6");' onMouseOut='mOut(this,"#ffffff");'>
		...
		<td>
			<a href="billing2.php?<? if($_GET[fix]=="true"){echo "fix=true&billing2_id=$_GET[billing2_id]&edit=true";}else{echo"action=add";}?>&customers_id=<?=$rs["customers_id"];?>&customers_p_id=<?=$rs["customers_p_id"];?>">
