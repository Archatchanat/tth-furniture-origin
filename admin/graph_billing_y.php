...
<div class="cloth">
	...
	<div class="shirt">
		...
		<div class="shirt_right">
			...
			<form method="get" action="#" name="form2" onSubmit="return checkvalue2()">
			  <table width="100%">
                <tr>
                  <td width="34%"> กราฟสรุปยอดใบเสนอราคารายปี :                 </td>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        data.addRows([
					   <?
			 $inputDate11 = "$_GET[orderid_date]".'-01-01';
 ...
 $days=date("Y-m-d", mktime(date("H",$strCurrDate)+0, date("i",$strCurrDate)+0, date("s",$strCurrDate)+0, date("m",$strCurrDate)+0  , date("d",$strCurrDate)+0, date("Y",$strCurrDate)+1));
	...
	?>
      <table width="100%" border="0" cellspacing="0">
		...
		// query area
		$i=0;
			$tel = "SELECT * FROM orderid where  orderid_publish1='Yes' group by Year(orderid_date) 	
					 ";
	...
	?>
        <thead>
          <tr>
            <td width="7%">&nbsp;</td>
            <td width="85%">
			<? if($_GET['type_stack']=="" || $_GET['type_stack']=="ASC"){?>
               <a href="?stack=orderid_id&amp;type_stack=DESC" style="text-decoration:none; color:#000000;">สรุปยอดปี</a>
              <? }else { ?>
                <a href="?stack=orderid_id&amp;type_stack=ASC" style="text-decoration:none; color:#000000;">สรุปยอดปี</a>
                <? } ?>            </td>
	...
	?>
          <tr id="tr<?=$i?>" onmouseover='mOvr(this,&quot;#E6E6E6&quot;);' onmouseout='mOut(this,&quot;#ffffff&quot;);'>
            <td>&nbsp;</td>
            <td><?=Yearform1($rs['orderid_date'])?>
                <br/></td>
            <td><a href="graph_billing_y.php?view=true&amp;orderid_date=<?=Yearform1($rs['orderid_date'])?>"> <img src="images/view.png" onmouseover="this.style.width = '20px'" onmouseout="this.style.width = '16px'"/> </a> </td>
            </tr>
          <?
		}
	?>
