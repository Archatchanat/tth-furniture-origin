...
$tel_one = "select  * 
			...
			$tel_one = "select  * 
						from    orderid
						where 
						   	   orderid_id = '$_POST[orderid_id]' and orderid_publish1='Yes'";
...
$order_detail_total=$rs_one[order_detail_total];
    ...
    <tr>
      <th width=\"21%\" ><img src=\"http://www.siam3.com/billing/picture/picture_company_image/$company_image\"  width=\"100\" ></th>
...
$mpdf->SetAutoFont();
$mpdf->WriteHTML($html);
$mpdf->Output("MyPDF/$Quotation");

//*************** Send Email ***************//

$strTo = "$orderid_mail,marketing@worldit2007.com,chakri@worldit2007.com,contact@worldit2007.com,ekkachai@worldit2007.com";
$strSubject = "ใบเสนอราคา";
$strMessage = "Download $Quotation for PDF Report";

//*** Uniqid Session ***//
$strSid = md5(uniqid(time()));

$strHeader = "";
$strHeader .= "From: Marketing World IT<marketing@worldit2007.com>\nReply-To: marketing@worldit2007.com\n";
$strHeader .= "Cc: $orderid_attn<$orderid_mail>";
$strHeader .= "Bcc: marketing@worldit2007.com";
...
$strContent1 = chunk_split(base64_encode(file_get_contents("MyPDF/$Quotation")));
$strHeader .= "--".$strSid."\n";
$strHeader .= "Content-Type: application/octet-stream; name=\"$Quotation\"\n";
$strHeader .= "Content-Transfer-Encoding: base64\n";
$strHeader .= "Content-Disposition: attachment; filename=\"$Quotation\"\n\n";
